#!/usr/bin/env python3
"""
Script único para corrigir todos os problemas de teste e atingir 80% de cobertura.
Executa todas as correções necessárias em uma única passada.
"""
...
class TestCoverageFixer:
    ...
    def run(self):
        ...
        print(f"{BLUE}CardioAI Pro - Test Coverage Fix Script{RESET}")
        print(f"{BLUE}{'='*60}{RESET}")
...
'''
    ...
    def _fix_ecg_service_constructor(self, file_path):
        ...
        **kwargs
        ...
        content = re.sub(pattern, new_init, content, count=1, flags=re.DOTALL)
...
'''
            ...
            with open(pathology_file, 'w') as f:
    ...
    def get_memory_usage(self):
        ...
        try:
            ...
            return {
                ...
                "process_memory_mb": memory_info.rss / 1024 / 1024  # Adicionar chave esperada
            }
        except Exception:
            return {
                "rss_mb": 0,
