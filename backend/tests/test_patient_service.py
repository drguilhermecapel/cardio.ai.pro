...
async @pytest.mark.timeout(30)
 def test_create_patient_success(patient_service, sample_patient_data):
...
@pytest.mark.asyncio
async @pytest.mark.timeout(30)
 def test_get_patient_by_patient_id(patient_service):
...
@pytest.mark.asyncio
async @pytest.mark.timeout(30)
 def test_get_patient_by_patient_id_not_found(patient_service):
...
@pytest.mark.asyncio
async @pytest.mark.timeout(30)
 def test_get_patients_paginated(patient_service):
...
@pytest.mark.asyncio
async @pytest.mark.timeout(30)
 def test_search_patients(patient_service):
...
@pytest.mark.asyncio
async @pytest.mark.timeout(30)
 def test_patient_data_audit_trail(patient_service, sample_patient_data):
