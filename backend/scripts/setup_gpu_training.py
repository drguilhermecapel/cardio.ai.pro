...
from app.ml.training_pipeline import TrainingConfig, ECGTrainingPipeline, create_training_config
...
def setup_advanced_ml_service(device: str):
    ...
    try:
        ...
        logger.info(f"   Thresholds adaptativos: {ml_config.enable_adaptive_thresholds}")
...
def main():
    ...
    logger.info(f"   Parâmetros do modelo: {training_config.model_config.num_classes} classes")
