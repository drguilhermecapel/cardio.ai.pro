...
from app.datasets.ecg_public_datasets import ECGDatasetDownloader, ECGDatasetLoader, ECGDatasetAnalyzer
...
def main():
    ...
    if download_results.get('physionet-challenge-2020'):
        try:
            ...
            stats = analyzer.analyze_dataset(challenge2020_records, "PhysioNet Challenge 2020")
            logger.info(f"PhysioNet Challenge 2020: {stats['total_records']} registros carregados")
    ...
    if download_results.get('physionet-challenge-2021'):
        try:
            ...
            stats = analyzer.analyze_dataset(challenge2021_records, "PhysioNet Challenge 2021")
            logger.info(f"PhysioNet Challenge 2021: {stats['total_records']} registros carregados")
    ...
    if loaded_datasets:
        ...
        try:
            unified_path = loader.create_unified_dataset(
                loaded_datasets,
                output_path="unified_ecg_dataset.h5"
            )
