...
class ECGHybridProcessor:
    ...
    def process_ecg_signal(self, signal: npt.NDArray[np.float64], 
        ...
        try:
            ...
            raise ECGProcessingException(f"ECG processing failed: {e}")
    ...
    async def process_ecg_with_validation(self, file_path: str, patient_id: int, 
        ...
        try:
            ...
            from ..core.exceptions import ECGProcessingException
            raise ECGProcessingException(f"Hybrid processing failed: {e}")
    ...
    def get_supported_formats(self) -> list[str]:
        ...
        if hasattr(self.hybrid_service, 'ecg_reader') and hasattr(self.hybrid_service.ecg_reader, 'supported_formats'):
