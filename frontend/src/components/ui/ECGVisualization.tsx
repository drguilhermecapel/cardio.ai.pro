...
const ECGVisualization: React.FC<ECGVisualizationProps> = ({
  ...
  return (
    <div className={`bg-gray-900/40 backdrop-blur-xl rounded-2xl border border-gray-700/50 shadow-2xl overflow-hidden ${className}`}>
      {/* Header */}
      ...
      <div className="relative">
        ...
        <div className="absolute top-4 left-4 space-y-2">
          <div className="flex items-center space-x-2 px-3 py-1 bg-gray-900/80 rounded-lg backdrop-blur-sm">
            ...
            <span className={`text-sm font-semibold ${getHeartRateColor()}`}>
              {heartRate} BPM
            </span>
          </div>
          ...
          <div className="flex items-center space-x-2 px-3 py-1 bg-gray-900/80 rounded-lg backdrop-blur-sm">
            ...
            <span className={`text-sm font-medium ${getRhythmColor()}`}>
              {rhythm}
            </span>
          </div>
        </div>
