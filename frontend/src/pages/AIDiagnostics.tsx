        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                Esta ferramenta de IA é apenas para assistência diagnóstica. 
                Sempre consulte um profissional médico qualificado para diagnóstico e tratamento definitivos.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Histórico do Paciente</label>
              <textarea
                rows={3}
                className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          {result ? (
            <div className="space-y-4">
                  ...
                  {result.diagnoses.map((diagnosis, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-3">
                      <div className="flex justify-between items-start">
                        ...
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getConfidenceBadge(diagnosis.confidence)}`}>
              ...
              <div>
                <h3 className="text-md font-medium text-gray-900 mb-2">Plano de Tratamento Sugerido</h3>
